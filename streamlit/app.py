...
fixed_acidity = st.slider("Acidité fixe", min_value=4.0, max_value=15.0, value=7.4, step=0.01)
...
residual_sugar = st.slider("Sucre résiduel", min_value=0.0, max_value=20.0, value=1.9, step=0.01)
...
alcohol = st.slider("Alcool", min_value=8.0, max_value=15.0, value=9.4, step=0.01)
