...
chlorides = st.slider("Chlorures", min_value=0.0, max_value=0.2, value=0.076, step=0.001)
...
density = st.slider("Densité", min_value=0.990, max_value=1.005, value=0.9978, step=0.0001)
